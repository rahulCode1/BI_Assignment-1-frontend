      ...
      <main className="bg-light py-3 ">
        <div className="container border-top">
          {loading ? (
            ...
            <section className="container container-fluid py-5 d-flex justify-content-between gap-5 flex-wrap">
              <div className="">
                <h1>{event.title} </h1>
                ...
                />
                <h5>Details: </h5>
                <p style={{ maxWidth: "500px" }}>{event.details}</p>
              ...
              <div>
                <div
                  className="bg-white rounded text-center w-100 p-3 p-md-4 mx-auto text-center"
                ...
                >
                  ...
                  <p className="fw-bold">₹ 5,000</p>
                </div>

                <h4 className="my-3 text-center">Speakers (2)</h4>

                <div className="text-center">
                  <div className="d-flex flex-wrap flex-md-nowrap gap-3 mx-auto w-100 w-md-75">
                  ...
                  <p className="my-3">
                    <span className="badge text-bg-danger py-2 px-5 fs-5">
                      RSVP
                    </span>
                  </p>
                </div>
